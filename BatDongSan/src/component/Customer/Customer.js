...
const User = ({ navigation }) => {
    ...
    const [user, setUser] = useState("Khách hàng tiềm năng")
    var Customer = [
        {
            Ten: "Khách hàng tiềm năng",
            chucNang: () => {
                setUser("Khách hàng tiềm năng")
        ...
        },
        {
            ...
            chucNang: () => {
                setUser("Khách hàng đồng sở hữu")
                setModalVisible(!modalVisible)
